# Python Neptune Data API Examples
...
## Configuration
Update the cluster configuration in `src/neptune_client.py`:
- `cluster_endpoint`: Your Neptune cluster endpoint (without https:// or port)
- `port`: Neptune port (typically 8182)
- `region`: AWS region where your Neptune cluster is deployed

## Examples
The main example (`src/neptune_client.py`) demonstrates direct SDK usage for:
